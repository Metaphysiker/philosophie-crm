...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { name: @institution.name, philosophie_society_id: @institution.philosophie_society_id } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { name: @institution.name, philosophie_society_id: @institution.philosophie_society_id } }
